...
export default {
  ...
  getTamShiftAppReqList: http.post('/hns/personnel/appform/tamshiftapp/getTamShiftAppReqList.json'),
  tamShiftAppReqPop: http.post('/hns/personnel/appform/tamshiftapp/tamShiftAppReqPop.do'),
  insertTamShiftApp: http.post('/hns/personnel/appform/tamshiftapp/insertTamShiftApp.json'),
  getApplStat: http.post('/hns/personnel/appform/tamshiftapp/getApplStat.json')
}
